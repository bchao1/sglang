...
| Z-Image 1024×1024 | 4,096 | 1,024 | 4.0× | **TBD** |
...
| Config | Stage split | Denoise | Speedup |
|--------|-------------|---------|---------|
| fullres | 50 @ 128² latent | TBD | 1.00× |
| dct_rewind L1 δ=0.05 | TBD | TBD | **TBD** |

### Wan 2.1 T2V 1.3B (50 steps, 480×832, 81 frames)

| Config | Stage split | Denoise | Speedup |
|--------|-------------|---------|---------|
| fullres | 50 @ 60×104 latent | TBD | 1.00× |
| dct_rewind L1 δ=0.01 | 23 @ 30×52 + 27 @ 60×104 | TBD | **1.65×** |
| dct_rewind L1 δ=0.02 | 27 @ 30×52 + 23 @ 60×104 | TBD | **1.86×** |
| dct_rewind L1 δ=0.05 | 33 @ 30×52 + 17 @ 60×104 | TBD | **2.32×** |
| dct_rewind L1 δ=0.10 | 37 @ 30×52 + 13 @ 60×104 | TBD | **2.78×** |
...
> TODO: generate combined speedup plot once benchmark sweeps are complete.
> Script: `scratch/final_PR_smoke/gen_combined_speedup_plot.py`
...
![FLUX.1 comparison](https://raw.githubusercontent.com/bchao1/sglang/dev/brian/scratch/spectral-progressive-flux/images/progressive/montage_compare.png)
...
<details>
<summary>Fullres vs dct_rewind δ=0.05 / δ=0.10 — quality comparison</summary>

> TODO: add FLUX.2 comparison images from scratch/spectral-progressive-flux2/images/
...
> TODO: add Z-Image comparison images from scratch/spectral-progressive-z-image/images/
...
<details>
<summary>Fullres vs dct_rewind δ=0.05 — video quality comparison</summary>

> TODO: add Wan T2V GIF comparisons from scratch/spectral-progressive-wan/images/
...
<details>
<summary>Fullres vs dct_rewind δ=0.05 / δ=0.20 — quality comparison</summary>

> TODO: add Qwen-Image comparison images from scratch/spectral-progressive-qwen/images/
...
| Model | Config | Wall time | Output |
|-------|--------|-----------|--------|
| FLUX.1 | fullres | TBD | TBD |
| FLUX.1 | dct_rewind δ=0.05 | TBD | TBD |
| FLUX.2-klein-4B | fullres | TBD | TBD |
| FLUX.2-klein-4B | dct_rewind δ=0.05 | TBD | TBD |
| Z-Image | fullres | TBD | TBD |
| Z-Image | dct_rewind δ=0.05 | TBD | TBD |
| Wan T2V 1.3B | fullres | TBD | TBD |
| Wan T2V 1.3B | dct_rewind δ=0.05 | TBD | TBD |
| Qwen-Image | fullres | TBD | TBD |
| Qwen-Image | dct_rewind δ=0.05 | TBD | TBD |
