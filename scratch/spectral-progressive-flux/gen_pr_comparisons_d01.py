...
OUT_DIR = Path(__file__).parent / "results" / "pr_images_d01"
DOC_DIR = Path(__file__).parent.parent / "docs_new" / "images" / "progressive_d01"
...
def make_side_by_side(
    ...
    lbl_pr = make_label_image(
        f"Progressive δ={DELTA}  denoise={denoise_pr:.1f}s  ({speedup:.2f}×)",
        thumb_w,
        bg=(0, 60, 30),
    )
