#!/usr/bin/env bash
# =============================================================================
# Z-Image progressive resolution — Group A timing benchmark
# =============================================================================
# Runs 4 configs (fullres + 3 progressive) for a single prompt,
# reports wall-clock and denoising-loop timing. Saves timing.json.
#
# Usage:
#   bash scratch/spectral-progressive-z-image/run_zimage_benchmark.sh
#   bash scratch/spectral-progressive-z-image/run_zimage_benchmark.sh --steps 20
# =============================================================================
set -euo pipefail
...
run_config() {
    ...
    if [[ -z "$denoise_s" ]]; then
        # Fallback: extract "generated successfully in X.XXX seconds"
